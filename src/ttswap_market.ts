...
export function handle_e_initGood(event: e_initGood): void {
        ...
        if (!proofstate.reverted) {
                ...
                trade_normalgood_quantity = proofstate.value.valueinvest;
                trade_normalgood_contruct = proofstate.value.invest;
...
export function handle_e_investGood(event: e_investGood): void {
        ...
        if (!proofstate.reverted) {
                ...
                if (!normalcurrentstate.reverted) {
                        normal_good.currentValue =
                                normalcurrentstate.value.currentState.div(
                                        BI_128
                                );
                        normal_good.currentQuantity =
                                normalcurrentstate.value.currentState.mod(
                                        BI_128
                                );
                        normal_good.investValue =
                                normalcurrentstate.value.investState.div(
                                        BI_128
                                );
                        normal_good.investQuantity =
                                normalcurrentstate.value.investState.mod(
                                        BI_128
                                );
                        normal_good.feeQuantity =
                                normalcurrentstate.value.feeQuantityState.div(
                                        BI_128
                                );
                        normal_good.contructFee =
                                normalcurrentstate.value.feeQuantityState.mod(
                                        BI_128
                                );
                } else {
                        normal_good.currentValue =
                                normal_good.currentValue.minus(
                                        proof.proofValue
                                );
                        normal_good.currentQuantity =
                                normal_good.currentQuantity.minus(
                                        proof.good1Quantity
                                );
                        ...
                        normal_good.investQuantity =
                                normal_good.investQuantity.minus(
                                        proof.good1Quantity
                                );
                        ...
                        normal_good.currentQuantity =
                                normal_good.currentQuantity.plus(
                                        normal_Quantity
                                );
                        normal_good.investValue =
                                normal_good.investValue.plus(invest_value);
                        normal_good.investQuantity =
                                normal_good.investQuantity.plus(
                                        normal_Quantity
                                );
                        normal_good.feeQuantity =
                                normal_good.feeQuantity.plus(
                                        normal_contructFee
                                );
                        normal_good.contructFee =
                                normal_good.contructFee.plus(
                                        normal_contructFee
                                );
                }

                normal_good.totalInvestQuantity =
                        normal_good.totalInvestQuantity.minus(
                                proof.good1Quantity
                        );
                normal_good.totalInvestQuantity =
                ...
                if (valuegoodid != "0") {
                        ...
                        newcustomer.investValue =
                                newcustomer.investValue.plus(invest_value);
                        newcustomer.investCount =
                                newcustomer.investCount.plus(ONE_BI);
                        ...
                        newcustomer.stakettsvalue =
                                newcustomer.stakettsvalue.plus(invest_value);
                        newcustomer.stakettscontruct =
                                newcustomer.stakettscontruct.plus(
                                        stakecontruct
                                );
                        newcustomer.save();
                        log_CustomerData(newcustomer, event.block.timestamp);
                        ...
                        if (!valuecurrentstate.reverted) {
                                ...
                                value_good.investValue =
                                        valuecurrentstate.value.investState.div(
                                                BI_128
                                        );
                                value_good.investQuantity =
                                        valuecurrentstate.value.investState.mod(
                                                BI_128
                                        );
                                value_good.feeQuantity =
                                ...
                                value_good.feeQuantity =
                                        value_good.feeQuantity.minus(
                                                proof.good2ContructFee
                                        );
                                value_good.contructFee =
                                        value_good.contructFee.minus(
                                                proof.good2ContructFee
                                        );
                                ...
                                value_good.feeQuantity =
                                        value_good.feeQuantity.plus(
                                                value_contructFee
                                        );
                                value_good.contructFee =
                                        value_good.contructFee.plus(
                                                value_contructFee
                                        );
                        }
                        ...
                        value_good.totalInvestQuantity =
                                value_good.totalInvestQuantity.plus(
                                        value_Quantity
                                );
                        ...
                        marketstate.totalInvestValue =
                                marketstate.totalInvestValue.minus(
                                        proof.proofValue
                                );
                        marketstate.totalInvestValue =
                        ...
                        tx.togoodQuantity =
                                event.params._valueinvest.mod(BI_128);
                        ...
                        ttsenv.poolasset = ttsenv.poolasset.plus(stakecontruct);
                        ttsenv.poolcontruct =
                                ttsenv.poolcontruct.plus(stakecontruct);
...
export function handle_e_disinvestProof(event: e_disinvestProof): void {
        ...
        if (!proofstate.reverted) {
                ...
                normal_good.totalDisinvestQuantity =
                        normal_good.totalDisinvestQuantity.minus(
                                normal_Quantity
                        );
                ...
                if (valuegoodid != "0") {
                        ...
                        let valuecurrentstate = TTSwap_Market.bind(
                                ...
                                Address.fromString(valuegoodid.toString())
                        );
                        if (!valuecurrentstate.reverted) {
                                value_good.currentValue =
                                        valuecurrentstate.value.currentState.div(
                        ...
                        value_good.totalDisinvestQuantity =
                                value_good.totalDisinvestQuantity.minus(
                                        value_Quantity
                                );
                        ...
                        marketstate.totalDisinvestValue =
                                marketstate.totalDisinvestValue.plus(
                                        proof.proofValue
                                );
                        ...
                        marketstate.totalDisinvestValue =
                                marketstate.totalDisinvestValue.minus(
                                        invest_value
                                );
                        ...
                        tx.fromgoodQuanity =
                                tx.fromgoodQuanity.minus(normal_Quantity);
                        tx.fromgoodfee = normal_fee;
                        tx.togoodQuantity = proof.good2Quantity;
                        tx.togoodQuantity =
                                tx.togoodQuantity.minus(value_Quantity);
                        ...
                        newcustomer.disinvestValue =
                                newcustomer.disinvestValue.plus(
                                        proof.proofValue
                                );
                        newcustomer.disinvestValue =
                                newcustomer.disinvestValue.plus(
